...
# Name is User + Month and Day: johnv0704
MACNAME=${USER}$(date +%m%d)
...
/usr/libexec/PlistBuddy -c "Set :FK_StandardViewSettings:IconViewSettings:iconSize 120" ~/Library/Preferences/com.apple.finder.plist
